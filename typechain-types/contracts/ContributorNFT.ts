...
export interface ContributorNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "TOP_CONTRIBUTOR_BADGE"
      | "approve"
      | "balanceOf"
      | "baseURI"
      | "contractOwner"
  ...
  encodeFunctionData(
    functionFragment: "TOP_CONTRIBUTOR_BADGE",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "contributorTokens",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export namespace NFTMintedEvent {
  export type InputTuple = [contributor: AddressLike, tokenId: BigNumberish];
  export type OutputTuple = [contributor: string, tokenId: bigint];
  export interface OutputObject {
    contributor: string;
    tokenId: bigint;
  }
...
export interface ContributorNFT extends BaseContract {
  connect(runner?: ContractRunner | null): ContributorNFT;
  ...
  TOP_CONTRIBUTOR_BADGE: TypedContractMethod<[], [bigint], "view">;
  ...
  contributorTokens: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  mintNFT: TypedContractMethod<
    [contributor: AddressLike, tokenURI: string],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "TOP_CONTRIBUTOR_BADGE"
  ...
  getFunction(
    nameOrSignature: "contributorTokens"
